...
import com.cysmic.androidkotlinexperiment.net.FetchResponse
import com.cysmic.androidkotlinexperiment.net.FetchStoryListAsync
import java.util.*
import javax.inject.Inject

class StoryRepository @Inject constructor() : FetchResponse {
  ...
  override fun onFetchResponse(list: List<Story>, message: String?) {
    data.value = list
